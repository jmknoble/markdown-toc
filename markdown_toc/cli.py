...
def _generate_comment(prog, argv, with_full_command=False, with_datestamp=False):
    ...
    if with_datestamp:
        template = "Generated by {command} on {datestamp}"
    else:
        template = "Generated by {command}"
    comment_text = template.format(command=command, datestamp=datestamp)
    return comment_text
